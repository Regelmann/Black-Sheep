...
48_SEGURIDAD_CATALOGO.sql       ← 🔴 vencimiento + rotación de tokens, auditoría, anti-abuso
```
...
2. Abrir `app.black-sheep.cl` → el stamp abajo debe decir **`v-BS-PLATFORM-V14.7`**
...
[ ] 3 · git push
[ ] 4 · Stamp en pantalla dice v-BS-PLATFORM-V14.7
